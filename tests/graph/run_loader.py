...
from src.graph.validators.structure_validator import validate_node_ids,validate_relationship
import os
current_dir = os.path.dirname(os.path.abspath(__file__))
FILE_PATH = os.path.join(current_dir, "..", "..", "data", "parsed", "35_2024_QH15_structure.json")
