...
def print_action_sample(sample):
    ...
    print(
        "  text_amendment:",
        action.get("text_amendment")
    )

    print(
        "  appendix_amendment:",
        action.get("appendix_amendment")
    )

    print(
        "  resolution_status:",
        action.get("resolution_status")
    )

    print(
        "  raw_instruction:",
        action.get("raw_instruction")
    )
